        ...
        <div className="fixed inset-0 z-[80] grid place-items-center p-4">
          ...
          >
            ...
            <div className="-mt-6 rounded-t-[30px] bg-cream px-7 pb-8 pt-6 text-center dark:bg-night-800">
              ...
              <div className="mt-6 flex items-center gap-2 rounded-2xl border border-dashed border-brand-800/30 bg-cream p-2 pr-4 dark:border-white/15 dark:bg-white/5">
