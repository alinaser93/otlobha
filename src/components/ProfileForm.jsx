...
export function Avatar({ name, url, size = 72, onPick }) {
...
/*
  ...
  props:
    ...
    title     : section title
*/
export default function ProfileForm({ initial = {}, readOnly = [], areas, show = {}, onSave, onPickPhoto, title = 'الملف الشخصي' }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <Avatar name={f.name || initial.username} url={initial.avatar_url} onPick={onPickPhoto} />
