...
import {
  ...
  ShoppingBag, Wallet, ChevronDown,
} from 'lucide-react';
      ...
      <main className="mx-auto max-w-5xl space-y-5 px-4 py-5">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {shown.map((o) => <OrderCard key={o.id} o={o} onStatus={setStatus} />)}
          </div>
        )}
      ...
      <div className="flex items-start justify-between gap-2">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className={`flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-[11px] font-bold ${st.chip}`}>
