...
const STATUS = {
  new: { label: 'جديد', dot: 'bg-amber-400', chip: 'border-amber-500/30 bg-amber-500/15 text-amber-300', glow: 'bg-amber-400/40' },
  preparing: { label: 'قيد التحضير', dot: 'bg-blue-400', chip: 'border-blue-500/30 bg-blue-500/15 text-blue-300', glow: 'bg-blue-400/40' },
  delivering: { label: 'جارٍ التوصيل', dot: 'bg-indigo-400', chip: 'border-indigo-500/30 bg-indigo-500/15 text-indigo-300', glow: 'bg-indigo-400/40' },
  done: { label: 'تم التوصيل', dot: 'bg-green-400', chip: 'border-green-500/30 bg-green-500/15 text-green-300', glow: 'bg-green-400/40' },
  cancelled: { label: 'ملغى', dot: 'bg-red-400', chip: 'border-red-500/30 bg-red-500/15 text-red-300', glow: 'bg-red-400/40' },
};
const TABS = [
