...
export default function OrderRating({ orderId, driverName }) {
  ...
  return (
    <div className="rounded-3xl bg-cream p-5 shadow-card dark:bg-night-800">
      <div className="mb-1 flex items-center gap-2">
        ...
        <h3 className="font-display text-lg font-extrabold text-ink dark:text-cream">قيّم طلبك</h3>
      </div>
      <p className="mb-3 text-xs text-ink/50 dark:text-cream/50">رأيك يساعد بقية الزبائن — التقييم متاح لأنك استلمت هذا الطلب 🌟</p>
