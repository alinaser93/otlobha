        ...
        <>
          ...
          >
            ...
            <div className="flex-1 space-y-4 overflow-y-auto p-5">
              ...
              {/* referral */}
              <div className="rounded-3xl bg-white p-5 shadow-soft dark:bg-night-800">
                ...
                {!editing ? (
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      placeholder="الاسم"
                      className="w-full rounded-xl border-2 border-ink/10 bg-white px-3 py-2.5 font-body text-ink outline-none focus:border-copper dark:border-white/10 dark:bg-night dark:text-cream"
                    />
                    <select
                      value={form.area}
