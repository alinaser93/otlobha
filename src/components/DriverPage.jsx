        ...
        <div>
          ...
          <AnimatePresence mode="popLayout">
            <motion.span key={cur}
              ...
              className="relative mt-1 inline-flex items-center gap-1.5 overflow-hidden rounded-full border border-copper/40 bg-copper/15 px-2.5 py-0.5 text-[11px] font-bold text-copper-light">
